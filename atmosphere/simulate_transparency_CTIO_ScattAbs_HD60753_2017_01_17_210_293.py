...
logdatafile='info/LogBook/2017/01/logbk_HD60753_ctio2017Jan17.fits'
...
if __name__ == "__main__":
    ...
    airmasses_indexes=event_number  # airmass index is replaced by event_number
...
#           ozon_str='O3 '+str(ozon_val)+ ' DU'          
           ...
           # 4) LOOP ON AIRMASSES 
               for index,amfileindex in np.ndenumerate(airmasses_indexes):
                    ...
                    #print '*AM loop **', index,'---',amfileindex
                    ...
                    #print '*AM loop **', index,'---',amfileindex,' file = ',BaseFilename
